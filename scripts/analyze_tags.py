...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze HTML tags in an HTML file and optionally print inner HTML for selected tags"
    )
    parser.add_argument(
        "filepaths", nargs="+", type=str, help="Path(s) to HTML file(s)"
    )
    parser.add_argument(
        "--tags", type=str, help="Comma-separated list of tags to print inner HTML"
    )
